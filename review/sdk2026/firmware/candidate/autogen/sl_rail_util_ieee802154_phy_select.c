...
#define RUNTIME_PHY_FEATURES (SL_RAIL_IEEE802154_PHY_FEATURE_2P4_GHZ | (SL_RAIL_UTIL_IEEE802154_RUNTIME_PHY_FEATURES_2P4_COEX) | (SL_RAIL_UTIL_IEEE802154_RUNTIME_PHY_FEATURES_2P4_RX_CH_SWITCHING))

#define DEFAULT_PHY_FEATURES (SL_RAIL_IEEE802154_PHY_FEATURE_2P4_GHZ | (SL_RAIL_UTIL_IEEE802154_DEFAULT_PHY_FEATURES_2P4_COEX) | (SL_RAIL_UTIL_IEEE802154_DEFAULT_PHY_FEATURES_2P4_RX_CH_SWITCHING))
...
#if SL_RAIL_UTIL_IEEE802154_RUNTIME_PHY_FEATURES_2P4_COEX
          | sl_rail_util_ieee802154_get_coex_phy_features()
#else
          | SL_RAIL_UTIL_IEEE802154_DEFAULT_PHY_FEATURES_2P4_COEX
#endif
...
static sl_rail_util_ieee802154_config_t sl_rail_util_ieee802154_supported_phys[] = {
...
#if IS_PHY_FEATURE_SUPPORTED(SL_RAIL_IEEE802154_PHY_FEATURE_2P4_GHZ_RX_DUTY_CYCLING)
  {
    ...
    .channel_config = &RAIL_IEEE802154_PhyRxDutyCycling
  },
#endif
